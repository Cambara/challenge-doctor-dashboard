...
import { IDesassociateLabDto } from './desassociate-lab.dto'
...
export class DesassociateLabService implements IService<IDesassociateLabDto, Response> {
  ...
  execute = async ({ labId, medicalAnalysisId, response }: IDesassociateLabDto): Promise<Response> => {
